...
// TestCoronaKeygenSimple tests basic keygen without the full protocol
func TestCoronaKeygenSimple(t *testing.T) {
	n := 3
	threshold := 2
...
// TestCoronaSignSimple tests basic signing without the full protocol
func TestCoronaSignSimple(t *testing.T) {
...
// TestCoronaRefreshSimple tests basic refresh without the full protocol
func TestCoronaRefreshSimple(t *testing.T) {
	// Create a test config
	cfg := config.NewConfig("test-party", 2, config.Security128)
	require.NotNil(t, cfg)
...
// TestCoronaProtocolTimeout tests that protocols respect timeout
func TestCoronaProtocolTimeout(t *testing.T) {
...
// TestCoronaConfigValidation tests configuration validation
func TestCoronaConfigValidation(t *testing.T) {
	testCases := []struct {
		name      string
		id        party.ID
		threshold int
...
// TestCoronaShareValidation tests share validation
func TestCoronaShareValidation(t *testing.T) {
	cfg := config.NewConfig("test-party", 2, config.Security128)
	require.NotNil(t, cfg)
...
// TestCoronaSignatureVerification tests signature verification
func TestCoronaSignatureVerification(t *testing.T) {
